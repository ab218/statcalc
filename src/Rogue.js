      ...
      <table>
        <tbody>
          ...
          <tr style={{color: 'purple'}}>
            ...
            <td>{(Math.floor(withSleep() * ((withAc * (((desiredVita * 0.83) * 1.8) + ((desiredMana * 0.98) * 0.45)))))).toLocaleString()}</td>
          </tr>
          <tr style={{color: 'purple'}}>
            <td>3rd Sa</td>
            <td>{(Math.floor(withSleep() * ((withAc * (((vita * Math.pow(0.83, 2)) * 1.8) + ((mana * Math.pow(0.98, 2)) * 0.45)))))).toLocaleString()}</td>
            <td>{(Math.floor(withSleep() * ((withAc * (((desiredVita * Math.pow(0.83, 2)) * 1.8) + ((desiredMana * Math.pow(0.98, 2)) * 0.45)))))).toLocaleString()}</td>
          </tr>
          <tr style={{color: 'purple'}}>
            <td>4th Sa</td>
            <td>{(Math.floor(withSleep() * ((withAc * (((vita * Math.pow(0.83, 3)) * 1.8) + ((mana * Math.pow(0.98, 3)) * 0.45)))))).toLocaleString()}</td>
            <td>{(Math.floor(withSleep() * ((withAc * (((desiredVita * Math.pow(0.83, 3)) * 1.8) + ((desiredMana * Math.pow(0.98, 3)) * 0.45)))))).toLocaleString()}</td>
          </tr>
          <tr style={{color: 'purple'}}>
            <td>5th Sa</td>
            <td>{(Math.floor(withSleep() * ((withAc * (((vita * Math.pow(0.83, 4)) * 1.8) + ((mana * Math.pow(0.98, 4)) * 0.45)))))).toLocaleString()}</td>
            <td>{(Math.floor(withSleep() * ((withAc * (((desiredVita * Math.pow(0.83, 4)) * 1.8) + ((desiredMana * Math.pow(0.98, 4)) * 0.45)))))).toLocaleString()}</td>
          </tr>
        </tbody>
      </table>
    </div>
